...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Choice.letter'
        db.alter_column(u'quizapp_choice', 'letter', self.gf('django.db.models.fields.CharField')(default='a', max_length=1))

    def backwards(self, orm):

        # Changing field 'Choice.letter'
        db.alter_column(u'quizapp_choice', 'letter', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))
