...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuizSession.name'
        db.add_column(u'quizapp_quizsession', 'name',
                      self.gf('django.db.models.fields.CharField')(default='a session', max_length=300),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuizSession.name'
        db.delete_column(u'quizapp_quizsession', 'name')
