...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuizSession.is_private'
        db.add_column(u'quizapp_quizsession', 'is_private',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuizSession.is_private'
        db.delete_column(u'quizapp_quizsession', 'is_private')
