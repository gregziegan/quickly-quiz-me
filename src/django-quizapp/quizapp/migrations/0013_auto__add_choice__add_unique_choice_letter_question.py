...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Choice'
        db.create_table(u'quizapp_choice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('letter', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['quizapp.Question'])),
        ))
        db.send_create_signal(u'quizapp', ['Choice'])

        # Adding unique constraint on 'Choice', fields ['letter', 'question']
        db.create_unique(u'quizapp_choice', ['letter', 'question_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Choice', fields ['letter', 'question']
        db.delete_unique(u'quizapp_choice', ['letter', 'question_id'])

        # Deleting model 'Choice'
        db.delete_table(u'quizapp_choice')
    ...
    models = {
        ...
        u'quizapp.choice': {
            'Meta': {'unique_together': "(('letter', 'question'),)", 'object_name': 'Choice'},
