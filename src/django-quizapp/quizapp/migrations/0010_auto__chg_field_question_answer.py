...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'quizapp_question', 'answer', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Question.answer'
        raise RuntimeError("Cannot reverse this migration. 'Question.answer' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Question.answer'
        db.alter_column(u'quizapp_question', 'answer', self.gf('django.db.models.fields.TextField')())
